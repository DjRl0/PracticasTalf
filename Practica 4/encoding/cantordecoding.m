...
##  fjv 20200116 decoding changed from left to right to fit with lecture notes
  ...
  elseif n == 2
    ...
    element2 = uint64(z - cantorencoding(diagonal, 0));
    ## first element
    element1 = uint64(diagonal - element2);
